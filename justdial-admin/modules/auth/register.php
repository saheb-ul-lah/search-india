...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    error_log("CSRF Token: " . ($_POST['csrf_token'] ?? ''));
    error_log("Email Verification Setting: " . getSetting('enable_email_verification', '1'));
    // Verify CSRF token
                ...
                <form class="space-y-4 md:space-y-6" method="POST">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full pl-10 p-2.5" placeholder="John Doe" value="<?= $name ?>" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="password" id="password" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full pl-10 p-2.5" required minlength="<?= PASSWORD_MIN_LENGTH ?>">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="confirm_password" id="confirm_password" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full pl-10 p-2.5" required minlength="<?= PASSWORD_MIN_LENGTH ?>">
                        </div>
                    </div>
